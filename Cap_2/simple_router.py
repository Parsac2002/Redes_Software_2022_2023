...
class SimpleRouter(app_manager.RyuApp):
    ...
    def _handle_icmp(self, datapath, port, pkt_original):
        ...
        dst=pkt_ethernet.src,src=self.hw_addr)) #Metemos cabecera ethernet en el paquete.

        pkt.add_protocol(ipv4.ipv4(dst=pkt_ipv4.src,src=self.ip_addr, # tambien pordria ser: pkt_ipv4.dst
